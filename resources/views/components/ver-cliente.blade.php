...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <br>
        <input class="form-control form-control-alternative" id="rsocial_cliente_modal_view_id">{{isset($model->id) ? $model->razon_social : '' }}</label>
    </div>
    <div class="form-group col-md-6"">
        <label class="form-label" for="telefono_cliente_modal_view_id">Telefono:</label>
        <br>
        <input id="telefono_cliente_modal_view_id" class="form-control form-control-alternative">{{isset($model->id) ? $model->telefono : ''}}</label>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-6">
        ...
        <br>
        <input class="form-control form-control-alternative" for="" id="identificacion_cliente_modal_view_id">{{isset($model->id) ? $model->identificacion : ''}}</label>
    </div>
    <div class="form-group col-md-6">
        <label class="form-label" for="tident_cliente_modal_view_id">Tipo identificacion:</label>
        <br>
        <input id="tident_cliente_modal_view_id" class="form-control form-control-alternative">{{isset($model->id) ? $model->tipo_identificacion : ''}}</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <br>
    <input class="form-control form-control-alternative" for="" id="direccion_cliente_modal_view_id">{{isset($model->id) ? $model->direccion : ''}}</label>
</div>
